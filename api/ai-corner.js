export default async function handler(req, res) {
  ...
  const prompt = `You write a tiny daily "AI Corner" widget for a restaurant chef/owner's personal dashboard. Give exactly 3 short items, each 1 sentence, practical and specific to running a restaurant (kitchen ops, menu, wine/cocktails, staff, guests). Respond ONLY as JSON, no markdown, no code fences, in this exact shape:
